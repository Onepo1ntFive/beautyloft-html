...
(function () {
  var menuBth = document.querySelector('.js-menu-sandwich');
  var menuItems = document.querySelector('.js-menu-items');
  var menuItem = document.querySelectorAll('.js-menu-items a');
...
(function () {
  //swiper
  var swiperRent = new Swiper('.js-swiper-rent', {
    navigation: {
      nextEl: '.swiper-button-next',
      prevEl: '.swiper-button-prev'
    },
...
(function () {
  //swiper
  var swiperReview = new Swiper('.js-swiper-review', {
    speed: 1000,
    loop: true,
    loopAdditionalSlides: 10,
    autoHeight: true,
